...
# которая будет это делать или сообщать,что без дополнительной информации это сделать
# невозможно.
# Input: 3 4 (ввод на разных строках)
# Output: 6

i = int(input('В какой вагон от головы поезда сел Витя? '))
j = int (input('Какой номер указан на вагоне? '))

if i == j:
    print('Не хватает данных!')
else:
    result =  i + j - 1
    print(f'Всего в электричке {result} вагонов')